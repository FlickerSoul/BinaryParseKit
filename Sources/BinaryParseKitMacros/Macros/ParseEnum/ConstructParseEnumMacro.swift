...
public struct ConstructEnumParseBodyMacro: ExtensionMacro {
    public static func expansion(
        of _: SwiftSyntax.AttributeSyntax,
        attachedTo declaration: some SwiftSyntax.DeclGroupSyntax,
        providingExtensionsOf type: some SwiftSyntax.TypeSyntaxProtocol,
...
private func buildEnumParseExtensions(
    attachedTo declaration: some SwiftSyntax.DeclGroupSyntax,
    providingExtensionsOf type: some SwiftSyntax.TypeSyntaxProtocol,
    ...
    let parsingExtension = try buildParsingExtension(
        ...
        includeConformances: includeConformances,
        context: context,
    )
...
private func buildParsingExtension(
    ...
    let header: String = includeConformances
        ? "extension \(type): \(Constants.Protocols.parsableProtocol)"
        : "extension \(type)"
    return try ExtensionDeclSyntax("\(raw: header)") {
...
private func buildPrinterExtension(
    type: some SwiftSyntax.TypeSyntaxProtocol,
    parseInfo: EnumParseInfo,
    accessorInfo: AccessorInfo,
    includeConformances: Bool,
